...
public class BgpSessionManagerTest {
    ...
    private static final long DEFAULT_COMMUNITY_ASN = 65000;
    private static final long DEFAULT_COMMUNITY_LOCAL_ID = 100;
    ...
    BgpRouteEntry.Communities defaultCommunities;
    BgpRouteEntry.extCommunities defaultExtCommunities;
    ...
    public void setUp() throws Exception {
        ...
        //
        BgpRouteEntry.Community defaultCommunity =
                new BgpRouteEntry.Community(Pair.of(DEFAULT_COMMUNITY_ASN,
                                                    DEFAULT_COMMUNITY_LOCAL_ID));
        ArrayList<BgpRouteEntry.Community> communityList =
                new ArrayList<>();
        communityList.add(defaultCommunity);
        //
        defaultCommunities = new BgpRouteEntry.Communities(communityList);

        // Setup Default Extended Community
        ArrayList<BgpRouteEntry.extCommunity> extCommunityList = new ArrayList<>();
        BgpRouteEntry.extCommunity defaultExtCommunity =
                new BgpRouteEntry.extCommunity(Triple.of(Long.valueOf(0),
                                                         Long.valueOf(64000),
                                                         Long.valueOf(100)));
        extCommunityList.add(defaultExtCommunity);
        BgpRouteEntry.extCommunities defaultExtCommunities =
